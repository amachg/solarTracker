# Κατασκευή Ρομποτικού Ηλιοτρόπιου - 7ο Γυμνάσιο Χαϊδαρίου
...
Για την υλοποίηση του έργου, χρειάστηκαν:
  - Αρχικά για το πρότυπο, ένα μέρος από υπάρχον κιτ ρομποτικού βραχίονα (arduino braccio) με έξι βαθμούς ελευθερίας, περιορισμένο στους δύο βαθμούς ελευθερίας. Και στο τελικό προϊόν, ρομποτική ιδιοκατασκευή με στρεφόμενο πλαίσιο (Pan/Tilt), αποτελούμενη από πλαστική βάση από θήκη DVD, στηρίγματα από σκληρό χαρτόνι, μεταλλικό άξονα και δύο σερβοκινητήρες, ροπής 5 κιλών ο καθένας με πλήμνες σύνδεσης (hubs).
...
Το τελικό Ηλιοτρόπιο δοκιμάστηκε και ικανοποίησε απόλυτα το σκοπό της εργασίας μας, όπως φαίνεται και στο βίντεο, οπότε κρίθηκε πετυχημένο.
...
https://user-images.githubusercontent.com/38431707/134211641-323c9101-6d16-47d2-bf2d-555b777f402c.mp4
