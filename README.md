...
Ο ρομποτικός μηχανισμός θα είναι ένας αρθρωτός βραχίονας που στηρίζει ένα συλλέκτη ηλιακής ενέργειας στην κορυφή του. Ο βραχίονας θα είναι δύο βαθμών ελευθερίας, ώστε να μπορεί να στρέφεται οριζόντια γύρω από τον άξονα του συλλέκτη και κάθετα γύρω από τον άξονα της βάσης του.
